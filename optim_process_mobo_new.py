...
def optim_process(
    ...
    n_init = 20, # Number of initial evaluations before suggesting optimized samples.
    n_iter = 100, # Number of sampling iterations
    normalization = False,
    DEBUG = True,
):
    ...
    ## ---------------------------create new points------------------------------- ## 
    # choose one method to get initial points:
    ...
    # choose the exact value as instead: f_disper = 1, f_tke = 0, f_cons = 0
    ...
    return pareto # TODO: return the X_sample that corresponds to pareto
