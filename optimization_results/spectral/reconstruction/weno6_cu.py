...
class WENO6CU(SpatialReconstruction):
    ...
    def reconstruct_xi(
        ...
        alpha_0 = self.dr_[0] * (self.C_ + tau_6 / (beta_0 + self.eps) )
        alpha_1 = self.dr_[1] * (self.C_ + tau_6 / (beta_1 + self.eps) )
        alpha_2 = self.dr_[2] * (self.C_ + tau_6 / (beta_2 + self.eps) )
        alpha_3 = self.dr_[3] * (self.C_ + tau_6 / (beta_3 + self.eps) )
